...
//        this.guess = document.createElement('input');
      this.recoverPassword = document.createElement('a');
      this.admision = document.createElement('a');
...
//        this.guess.placeholder = options.guessLabel;
      ...
      this.title.className = 'login-image';
...
//        this.guess.className = 'login-input';
      ...
      this.imageContainer.appendChild(this.title);
