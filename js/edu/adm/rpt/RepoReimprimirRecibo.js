...
var RepoReimprimirRecibo = {
	...
	dlgReimprimirRecibo_Init : function() {
        ...
        dlgReimprimirRecibo.leftMarginObj(5,1,0,356);
        dlgReimprimirRecibo.addLn(6,1,1);
		dlgReimprimirRecibo.setHeightCell(6,1,10);
		dlgReimprimirRecibo.addObjToDialog(imgButtonsReciboImprimirReImpr,7,1,1);
		dlgReimprimirRecibo.addObjToDialog(imgButtonsReciboImprimirBuscar,7,1,1);
        dlgReimprimirRecibo.addObjToDialog(imgButtonsReciboImprimirLimpiar,7,1,1);
        dlgReimprimirRecibo.addObjToDialog(imgButtonsReciboImprimirAnular,7,1,1);
        dlgReimprimirRecibo.addObjToDialog(imgButtonsReciboImprimirSalir,7,1,1);
        dlgReimprimirRecibo.adjAllMarginObj(7,1,25);
        dlgReimprimirRecibo.leftMarginObj(7,1,0,190);
        dlgReimprimirRecibo.addLn(8,1,1);
		dlgReimprimirRecibo.setHeightCell(8,1,10);
        dlgReimprimirRecibo.addObjToDialog(gridsReciboImprimir.getObject(),9,1,1);
	},
	...
	create : function() {
		dlgReimprimirRecibo = dialogs.create('dlgReimprimirRecibo',0,0,990,540,'REIMPRIMIR RECIBO / FACTURA');
		dlgReimprimirRecibo.setAdjY(20);
		pcbReciImpNivAcademico = powerComboBox.create('pcbReciImpNivAcademico', 'pcbReciImpNivAcademico', 'Centro de Salud :', 1,137);
		...
		editsRepoReImprIdDoc = edits.create('editsRepoReImprIdDoc','editsRepoReImprIdDoc','Documento Nº (*):',1,122,'normal');
		...
		pcbReciImpTipDocumento = powerComboBox.create('pcbReciImpTipDocumento', 'pcbReciImpTipDocumento', 'Tipo Documento (+):', 1,124);
		pcbReciImpTipDocumento.setWidthCombo(95);
