...
var RepoLisAluConDeuda = {
    ...
    create : function(){
    	dialogsRepoLisAluConDeuda = dialogs.create('dialogsRepoLisAluConDeuda',0,0,924,577,'PACIENTE CON DEUDA');
		...
		editsRepoLisAluConDeuApellido.setMaxLength(20);
      	...
      	imgButtonsRepoLisAluConDeuRepre = imgButtons.create('imgButtonsRepoLisAluConDeuRepre','Deuda Por Paciente','print.png');
      	imgButtonsRepoLisAluConDeuReporte = imgButtons.create('imgButtonsRepoLisAluConDeuReporte','Deuda Por Paciente','print.png');
