...
var RepoCieDiaCaja = {
    ...
    dialogsRepoCieDiaCaja_init: function(){
        ...
        dialogsRepoCieDiaCaja.addObject(imgButtonsRepoCieDiaCajaResumen, 115, 165);
    ...
    limpiar : function(tipo) {
    	...
    	calendarRepoCieDiaCajDesde.setFechaToEdit(Tool.getDate());
		calendarRepoCieDiaCajHasta.setFechaToEdit(Tool.getDate());
