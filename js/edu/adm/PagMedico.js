...
var PagMedico = {
	...
	createMWs : function() {
		mwPagMedico  = desktop.addMinWindow('Facturar', this.windowName + '.show()', this.windowName + '.hide()', this.windowName + '.hide()');
	...
	gridsPagoDatMedico_Init : function(totalRows) {
		...
		gridsPagoDatMedico.addTitleVectorX(['EDO.','C.I.','Apellido','Nombre','Fecha','Monto'/*,'Modo Ingreso','F. Egreso','Saldo'/*,'idpers','idmodingreso','id_inst','idorg','idsuborg','idcarr','deingreso','idIngreso','idPeri','idPosi','cell','inscrito'*/]);
...
//		gridsPagoRecConcepto.alignBarTitle('left');
	...
	create : function() {
		dialogsPagMedico = dialogs.create('dialogsPagMedico',0,0,865,600,'PAGO DE HONORARIOS MEDICOS');
