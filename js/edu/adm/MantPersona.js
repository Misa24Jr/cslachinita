...
var SubMenuPersona = {	
		idPanelMenu : 1,
		level : 1,
		captions : ['Paciente / Representante','Ubicaci�n Geografica','Admision','Ficha del Paciente','Profesi�n','Tipo de Persona'],
...
var SubMenuUbiGeo = {	
		idPanelMenu : 2,
		level : 2,
		captions : ['Pa�s','Regi�n','Ciudad','Asociar Ubicaci�n'],
...
var MantPersona = {
    ...
    dialogsMantPersona_Init: function() {
        //INSERCION DE OBJETOS AL DIALOGO
         ...
         powerComboBoxMantPerSexo.addOptionAndSimpleValue(null, 'Masculino', 'Masculino');
        	...
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Way�u', 'Way�u');
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'A�u', 'A�u');
        	...
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Bar�', 'Bar�');
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Piapoko', 'Piapoko');
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Pem�n', 'Pem�n');
        	powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Kari�a', 'Kari�a');
         ...
         powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Akawayo', 'Akawayo');
	      ...
	      powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Yanomami', 'Yanomami');
			...
			powerComboBoxMantPerIndigena.addOptionAndSimpleValue(null, 'Waiker�', 'Waiker�');
			...
			dialogsMantPersona.addObject(imgButtonsMantPerAgregar, 20, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerModificar, 132, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerEliminar, 244, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerLimpiar, 356, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerListado, 468, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerFicha, 580, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerBuscar, 692, 490);
			dialogsMantPersona.addObject(imgButtonsMantPerSalir, 804, 490);
    ...
    gridsMantPersona_Init: function() {
        ...
        gridsMantPersona.addTitleVectorX(['C.i.', 'Nombre', 'Apellido', 'Id.', 'Tlf. Habitaci�n', 'Nacionalidad', 'E. Civil', 'Email-1', 'indigena', 'Grupo Sanguineo', 'Estado', 'Sexo', 'Tlf. Celular', 'Pa�s', 'F.Nacimiento', 'Region', 'Ciudad', 'Profesi�n', 'Rif', 'Direcci�n', 'C. Emergencia', 'passport', 'mcpio', 'parroq']);
    ...
    create: function() {
        ...
        editsMantPerDireccion = edits.create('editsMantPerDireccion', 'editsMantPerDireccion', 'Direcci�n:', 1,80, 'normal');
        ...
        powerComboBoxMantPerRegion = powerComboBox.create('powerComboBoxMantPerRegion', 'powerComboBoxMantPerRegion', 'Regi�n (^):', 1,80);
        powerComboBoxMantPerCiudad = powerComboBox.create('powerComboBoxMantPerCiudad', 'powerComboBoxMantPerCiudad', 'Ciudad:', 1,70);
        powerComboBoxMantPerProfesion = powerComboBox.create('powerComboBoxMantPerProfesion', 'powerComboBoxMantPerProfesion', 'Profesi�n:', 1,70);
        ...
        //GRIDS
        gridsMantPersona = grids.create('gridsMantPersona', 8, 24);
        //CALENDARS
		...
		//////////////////////////////////////////////////////
		  ...
		  //hint.addToHintWithRefreshPos(editsMantPerTelHabitacion,dialogsMantPersona,"Escriba el Telefono de Habitaci�n",69,188,true);
		  //hint.addToHintWithRefreshPos(editsMantTelCelular,dialogsMantPersona,"Escriba el Telefono Celular",309,188,true);
		  //hint.addToHintWithRefreshPos(editsMantPerRif,dialogsMantPersona,"Escriba el Registro de Informaci�n Fiscal (Rif)",41,117,true);
	...
	reporte : function() {
		...
		var aData = [['C.I.','Nombre','Apellido','Tipo de Persona','Nacionalidad','Estado Civil','Profesi�n','Sexo','Fecha de Nacimiento','Rif','Grupo Sanguineo',
					  'Estado','Pais','Regi�n','Ciudad','Email','Indigena','N� Historia','Telefono de Habitaci�n','Telefono Movil','Direcci�n'],  	
	...
	reporteListado : function() {
		...
		rep.addTable('TablaRepoHojaEvaAlumno',['N�','C.i.','Nombre y Apellido','Profesi�n','Telefono','Email','Direcci�n'],562,40);
