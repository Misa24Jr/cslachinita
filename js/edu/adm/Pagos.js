...
var Pagos = {
	...
	dialogsPagos_Init : function() {
		...
		var c1 = container.create("c1",'DATOS DEL PACIENTE', 2);
		...
		c2.addObject(imagesPagoRecIncluir, 545,304);
...
/*		pcbPagoRecConcepto = powerComboBox.create('pcbPagoRecConcepto', 'pcbPagoRecConcepto', 'Concepto:', 1,64);
		...
		hint.addToHintWithRefreshPos(imagesPagoRecIncluir, dialogsPagos,"Buscar Concepto",485,280,false,true);
