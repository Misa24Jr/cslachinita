...
var SubMenuAdmision = {	
	idPanelMenu : 1,
	level : 1,
    captions : ['Persona','Relaci�n Estudiante Representante','Ingreso de Estudiante','Instituci�n de Procedencia','Profesi�n','Periodo','Inscripci�n'],
...
var Admision = {
	...
	createMWs: function() {
		mwAdmision = desktop.addMinWindow('Admisi�n', this.windowName + '.show()', this.windowName + '.hide()', this.windowName + '.hide()');
	...
	dialogsAdmision_Init: function() {
  	...
  	create: function() {
		dialogsAdmision = dialogsAdmi.create('dialogsAdmision',0,0,854,552,'ADMISI�N');
        ...
        pbcAdmisionRaza = powerComboBox.create('pbcAdmisionRaza','pbcAdmisionRaza','Ind�gena :',1,82);
        ...
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Way�u', 'Way�u');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'A�u', 'A�u');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Yukpa', 'Yukpa');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Japreria', 'Japreria');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Bar�', 'Bar�');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Piapoko', 'Piapoko');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Pem�n', 'Pem�n');
        pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Kari�a', 'Kari�a');
		...
		pbcAdmisionRaza.addOptionAndSimpleValue(null, 'Waiker�', 'Waiker�');
        ...
        pbcAdmisionPais = powerComboBox.create('pbcAdmisionPais','pbcAdmisionPais','Pa�s :',1,82);
        ...
        pbcAdmisionRegion = powerComboBox.create('pbcAdmisionRegion','pbcAdmisionRegion','Regi�n :',1,79);
        ...
        pbcAdmisionPosicion = powerComboBox.create('pbcAdmisionPosicion','pbcAdmisionPosicion','Posici�n :',1,79);                
		...
		pbcAdmisionProfesionMadre = powerComboBox.create('pbcAdmisionProfesionMadre','pbcAdmisionProfesionMadre','Profesi�n :',1,82);
		...
		pbcAdmisionProfesionPadre = powerComboBox.create('pbcAdmisionProfesionPadre','pbcAdmisionProfesionPadre','Profesi�n :',1,82);
		...
		imagesAdmisionPadre = images.create('imagesAdmisionPadre','imagesAdmisionPadre','images/pht/anonymous.png');			
  		...
  		pbcAdmisionProfesionRepre = powerComboBox.create('pbcAdmisionProfesionRepre','pbcAdmisionProfesionRepre','Profesi�n :',1,79);
		...
		editsAdmisionRepreDireccion	= edits.create('editsAdmisionRepreDireccion','editsAdmisionRepreDireccion','Direcci�n :',1,82,'normal');
		editsAdmisionRepreDireccion.setSizeEdit(632);
		editsAdmisionRepreDireccion.setMaxLength(150);
		editsAdmisionRepreObserv = edits.create('editsAdmisionRepreObserv','editsAdmisionRepreObserv','Observaci�n :',1,82,'normal');
